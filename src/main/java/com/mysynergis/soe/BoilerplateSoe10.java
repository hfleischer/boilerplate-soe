...
/**
 * boilerplace ServerObjectExtension (arcobjects)
 *
 * @author h.fleischer
 * @since 13.10.2019
 *
...
@ArcGISExtension
@ServerObjectExtProperties(displayName = ABoilerplateExtension.SOE_NAME + " (arcobjects)", description = ABoilerplateExtension.SOE_DESC + " (arcobjects)", properties = { "config=DEFAULT" })
public class BoilerplateSoe10 extends ABoilerplateExtension implements IServerObjectExtension, IRESTRequestHandler, IWebRequestHandler, IRequestHandler, IRequestHandler2, IObjectConstruct {
